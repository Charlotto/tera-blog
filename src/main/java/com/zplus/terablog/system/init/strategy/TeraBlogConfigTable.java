...
public class TeraBlogConfigTable implements TableInfoService {
    ...
    public void builderTable(final Statement stat) {
        try {
            ...
            log.error("初始化terablog_config失败", e);
        }
    }
    ...
    private static String initData() {
        return "INSERT INTO `terablog_config` VALUES " +
                "(1, 'name', 'terablog', 0)," +
                "(2, 'domain', 'http://127.0.0.1', 0)," +
                "(3, 'keywords', 'java', 0)," +
                "(4, 'description', 'java', 0)," +
                "(5, 'metas', '1.1.1', 0)," +
                "(6, 'copyright', 'Copyright @ terablog', 0)," +
                "(7, 'icp', 'xxxx', 0)," +
                ...
                "(26, 'cos_path', '', 5)," +
                "(27, 'default_path', '', 6)," +
                "(28, 'default_image_domain', 'http://127.0.0.1:8086/api/terablog-service/', 6)" +
                ";";
    }
}
