...
import com.zplus.terablog.common.util.HttpContextUtils;
...
import com.zplus.terablog.system.sync.LogSyncTask;
...
public class LogAspect {
    ...
    @Pointcut(value = "@annotation(com.zplus.terablog.common.annotation.OperateLog)")
